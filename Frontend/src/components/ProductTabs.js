          ...
          >
            <div style={{ width: "50%", margin: "20px" }}>
              <ol style={{ padding: "0" }}>
                <li>
                  <p>
                    Step on a piece of paper with your heel slightly touching a
                    wall behind
                  </p>
                </li>
                <li>
                  <p>
                    Mark the end of your longest toe on the paper (you might
                    need a friend to help you) and measure from the wall to the
                    marking.
                  </p>
                </li>
                <li>
